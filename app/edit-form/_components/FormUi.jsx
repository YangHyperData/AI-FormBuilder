...
function FormUi({ jsonForm, onFieldUpdate, deleteField, selectedTheme,
    selectedBackground, selectedStyle, editable = true, formId = 0 , enabledSignIn=false}) {
                ...
                <div key={index} className='flex items-center gap-2'>
                    {field.fieldType == 'select' ?
                        <div className='my-3 w-full'>
                            <label className='text-sx text-gray-500'>{field.label}</label>
                            ...
                            : field.fieldType == 'checkbox' ?
                                ...
                                : <div className='my-3 w-full'>
                                    ...
                                    <Input type={field?.type} placeholder={field.placeholder} name={field.fieldName}
                                        className="bg-transparent" onChange={(e) => handleInputChange(e)} required={field?.required}
                                    />
                                </div>}
